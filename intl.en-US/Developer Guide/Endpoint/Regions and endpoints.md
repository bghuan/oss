...
-   Accelerate endpoint outside mainland China: oss-accelerate-overseas.aliyuncs.com |
...
-   Accelerate endpoint outside mainland China: oss-accelerate-overseas.aliyuncs.com |
|China \(Zhangjiakou-Beijing Winter Olympics\)|oss-cn-zhangjiakou|oss-cn-zhangjiakou.aliyuncs.com|oss-cn-zhangjiakou-internal.aliyuncs.com|-   Global accelerate endpoint: oss-accelerate.aliyuncs.com
-   Accelerate endpoint outside mainland China: oss-accelerate-overseas.aliyuncs.com |
...
-   Accelerate endpoint outside mainland China: oss-accelerate-overseas.aliyuncs.com |
|Singapore \(Singapore\)|oss-ap-southeast-1|oss-ap-southeast-1.aliyuncs.com|oss-ap-southeast-1-internal.aliyuncs.com|-   Global accelerate endpoint: oss-accelerate.aliyuncs.com
-   Accelerate endpoint outside mainland China: oss-accelerate-overseas.aliyuncs.com |
...
-   2Transfer acceleration endpoints include global accelerate endpoints and accelerate endpoints outside mainland China. Accelerate endpoints take effect after transfer acceleration is enabled. For more information, see [Transfer acceleration](/intl.en-US/Developer Guide/Buckets/Transfer acceleration.md).
...
**Note:** When you access OSS internal endpoints by using Cloud Enterprise Network \(CEN\), Express Connect, leased lines, or VPN, you must configure routes for network products. OSS divides internal VIP address ranges for each region into fixed address ranges. When you configure routes based on regions, you must configure complete four or six Class C IP address ranges as listed in the following table.
...
-   100.118.172.0/24
-   100.118.173.0/24 |
|China \(Zhangjiakou-Beijing Winter Olympics\)|oss-cn-zhangjiakou|oss-cn-zhangjiakou-internal.aliyuncs.com|-   100.118.90.0/24
-   100.98.159.0/24
-   100.114.0.0/24
-   100.114.1.0/24 |
...
-   100.99.111.0/24
-   100.99.112.0/24 |
|China \(Ulanqab\)|oss-cn-wulanchabu|oss-cn-wulanchabu-internal.aliyuncs.com|Submit a ticket to obtain VIP address ranges.|
